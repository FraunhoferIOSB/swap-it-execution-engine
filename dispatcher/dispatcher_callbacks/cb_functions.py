...
class DispatcherCallbackFunctions:
    ...
    def __init__(self, server_instance: object, server: object, data_object, opcua_data_converter, ee_data_converter) -> object:
        self.server = server
        self.server_instance = server_instance
        self.service_execution_list = ExecutionList()
        self.data_object = data_object
        self.callback_helpers = CallbackHelpers(self.data_object)
    ...
    async def read_struct_parameter_from_server(self, variable_name, task_id):
        return self.ee_data_converter.convert_opcua_to_ee(variable_name, await self.server.data_object.read_struct_values(task_id, variable_name), self.server)
