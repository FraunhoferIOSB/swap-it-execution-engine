...
to generate the corresponding types. This API is describe in :ref:`Generate OPC UA Types`. Tasks (3 in Figure 1) and Service Results (4 in Figure 1)
are added and remove from the Data Object as described in :ref:`Data Object`. Lastly,
