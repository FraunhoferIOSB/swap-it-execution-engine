...
class ControlInterface:
    ...
    def __init__(self, server, server_instance, service_execution_list, target_server_list, device_registry_url, assignment_agent_url, docker, iteration_time, log_info, timeout, order_id):
        self.server = server
